...
import { applyOpenCodeSessionHeader } from "./opencode-session.js";
...
import { VaultScanner, sanitizePageTitle, sanitizePageRel, ensureVaultSkeleton, defaultVaultRoot } from "./vault.js";
import { commitVault, ensureVaultGit, isInsideVault } from "./vault-git.js";
...
export async function apply(ctx) {
    ...
    if (typeof ctx.on === 'function') {
        const vaultEditIntent = (target, _exec, next) => {
