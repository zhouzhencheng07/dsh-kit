...
export function validateFile(raw) {
    if (typeof raw !== 'string' || raw.trim() === '')
...
export function withinTree(dirReal, targetReal) {
...
export function invalidFsName(raw) {
