...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      cfgOpencodeGoEnabled: "OpenCode Go 兼容",
      cfgOpencodeGoEnabledHint: "发往 opencode.ai 的推理请求自动镜像会话头（需该 provider 配置 compat.sendSessionAffinityHeaders=true）；dsh 原生支持后可关",
      cfgVaultRoot: "知识库目录",
    ...
    const en = {
      ...
      cfgOpencodeGoEnabled: "OpenCode Go compatibility",
      cfgOpencodeGoEnabledHint: "Mirror the session header on requests to opencode.ai (requires compat.sendSessionAffinityHeaders=true on that provider); can be turned off once dsh supports it natively",
...
`;
    ...
    const CFG_FIELDS = [
      ...
      { key: "opencodeGoEnabled", kind: "bool" },
    ...
    const CFG_GROUPS = [
      ...
      { switchKey: "opencodeGoEnabled", fields: [] },
